    ...
    >
      ...
      <motion.span
        className={`absolute left-0 top-0 ${
          screenTheme ? "text-[#ffffff]" : "text-[#010409]"
...
export default function Navbar() {
  ...
  return (
    <div
      className={`px-60 h-16 flex items-center justify-between ${
        screenTheme ? "bg-[#010409]" : "bg-[#ffffff]"
      }`}
    >
      {/* Left: Logo */}
      <button className="flex items-center">
        ...
        <h1
          className={`text-xl ml-3 saira-fronttext h-[34px] flex items-end font-bold ${
            screenTheme ? "text-[#ffffff]" : "text-[#010409]"
          }`}
        >
